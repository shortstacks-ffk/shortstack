...
import {
  ...
  gradeSubmission,
} from "@/src/app/actions/assignmentActions";
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="p-2 min-h-[400px]">
          {submissions.length > 0 ? (
            ...
            <div className="text-center w-full justify-center items-center pt-28">
  ...
  return (
    <TableRow>
      ...
      <TableCell>
        <div>
          <span
            className={`font-medium ${submission.grade !== null ? "text-green-600" : "text-gray-400"}`}
          >
