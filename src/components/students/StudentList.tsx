...
// import { getStudentsByClass, deleteStudent, getAvailableStudents } from '@/src/app/actions/studentActions';
...
//   // Add the DeleteStudentDialog component before the closing div of the component:
